...
public class GameTest {
    ...
    public void setup() {
        game = new Game(
            new Team("GRYFFINDOR", "Oliver", "Harry", new String[] {"Angelina", "Ginny", "Katie"}),
            new Team("SLYTHERIN", "Vincent",  "Draco", new String[] {"Bridget", "Harper", "Malcolm"})
        );
    }
    ...
    public void quaffleScoreTest() {
        ...
        game.quaffleScore(team);
        assertEquals(game.getQuafflePoints() * 2, game.getScore(team), 0);
    }
    ...
    public void catchSnitchTest() {
        ...
        assertEquals(game.getSnitchPoints(), game.getScore(team), 0);
    }
}
